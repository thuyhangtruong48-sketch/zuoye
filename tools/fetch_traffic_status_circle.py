...
DEFAULT_OUTPUT = ROOT / "data" / "traffic_status_circle.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fetch AMap real-time circle traffic status.")
    parser.add_argument("--location", required=True, help="Center point as lon,lat.")
